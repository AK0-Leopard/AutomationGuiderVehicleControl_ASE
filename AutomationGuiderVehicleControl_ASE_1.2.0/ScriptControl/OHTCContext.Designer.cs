// 已啟用模型 'C:\Git\AK0-Leopard\AutomationGuiderVehicleControl_ASE\AutomationGuiderVehicleControl_ASE\AutomationGuiderVehicleControl_ASE_1.2.0\ScriptControl\OHTCContext.edmx' 的 T4 程式碼產生。
